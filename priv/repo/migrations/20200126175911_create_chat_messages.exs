defmodule GymRats.Repo.Migrations.CreateChatMessages do
  ...
  def change do
    ...
    create_if_not_exists index(:chat_messages, [:challenge_id],
                           name: "index_chat_messages_on_challenge_id"
                         )

    create_if_not_exists index(:chat_messages, [:gym_rats_user_id],
                           name: "index_chat_messages_on_gym_rats_user_id"
                         )
  end
end
