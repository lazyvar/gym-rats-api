defmodule GymRats.Repo.Migrations.CreateGymRatsUsers do
  ...
  def change do
    ...
    create_if_not_exists unique_index(:gym_rats_users, [:email],
                           name: "index_gym_rats_users_on_email"
                         )

    create_if_not_exists unique_index(:gym_rats_users, [:reset_password_token],
                           name: "index_gym_rats_users_on_reset_password_token"
                         )
  end
end
